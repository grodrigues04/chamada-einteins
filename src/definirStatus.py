...
def definirStatus(primeira_metade, segunda_metade,nome,data):
    ...
    if primeira_metade=="FALSE" and segunda_metade=="FALSE":#Então ele veio
        ...
        status = 'ms' #Sem registro na primeira metade, porém presente segunda metade
        total = 1
        ...
        status = 'mp' #Sem registro na segunda metade, porém foi registrado presença na primeira metade 
        total = 1
    #print(status)      
